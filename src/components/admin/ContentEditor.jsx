...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'timeline_floral_right', label: 'Adorno vertical — lado derecho del programa del día (también enmarca el RSVP)', type: 'image' },
      { key: 'story_photo_frame_image', label: 'Marco dorado para el carrusel de "Nuestra Historia" (PNG con centro transparente)', type: 'image' },
      { key: 'rsvp_top_image', label: 'Imagen horizontal sobre el formulario de RSVP', type: 'image' },
      { key: 'rsvp_bottom_image', label: 'Imagen horizontal bajo el formulario de RSVP', type: 'image' },
    ],
  },
  {
