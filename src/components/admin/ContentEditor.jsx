...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'pet_overlay_image', label: 'Marco/adorno sobre las mascotas (perro, gato y gato del código de vestimenta)', type: 'image' },
      { key: 'timeline_separator_image', label: 'Separador horizontal del programa del día (arriba y abajo)', type: 'image' },
      { key: 'timeline_floral_left', label: 'Adorno vertical — lado izquierdo del programa del día', type: 'image' },
      { key: 'timeline_floral_right', label: 'Adorno vertical — lado derecho del programa del día', type: 'image' },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'dress_code_note', label: 'Nota sobre la imagen (ej. "Mayores indicaciones...")', type: 'text' },
